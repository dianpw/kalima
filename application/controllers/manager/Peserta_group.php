...
class Peserta_group extends Member_Controller {
    ...
    function tambah(){
        ...
        $this->form_validation->set_rules('tambah-group', 'Nama Kelas','required|strip_tags');
    ...
    function edit(){
		...
		$this->form_validation->set_rules('edit-group', 'Nama Kelas','required|strip_tags');
        $this->form_validation->set_rules('edit-pilihan', 'Pilihan','required|strip_tags');
        $this->form_validation->set_rules('edit-group-asli', 'Nama Kelas','required|strip_tags');

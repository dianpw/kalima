...
class Modul_topik extends Member_Controller {
    ...
    public function index($page=null, $id=null){
        ...
        $this->template->display_admin($this->kelompok.'/topik_view', 'Daftar Mata Pelajaran', $data);
    }
    ...
    function edit(){
		...
		$this->form_validation->set_rules('edit-topik', 'Nama Mata Pelajaran','required|strip_tags');
        ...
        $this->form_validation->set_rules('edit-topik-asli', 'Nama Mata Pelajaran','required|strip_tags');

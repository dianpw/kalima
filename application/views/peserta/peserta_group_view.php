                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-group" name="tambah-group" placeholder="Nama Kelas">
                            </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit-group" name="edit-group" placeholder="Nama Kelas">
                            </div>

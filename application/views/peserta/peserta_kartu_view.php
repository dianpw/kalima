	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Lakukan Pengaturan nama pelaksana KALIMA TEST sebelum mencetak kartu peserta agar kartu sesuai dengan Organisasi tempat anda melaksanakan Tes.</p>
                <p>Pastikan terlebih dahulu data Kelas dan data Peserta sudah ter-upload.</p>
            </div>
        </div>
    </div>
	<div class="row">

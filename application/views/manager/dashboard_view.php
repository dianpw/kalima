...
<section class="content">
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif KALIMA TEST, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan KALIMA TEST.</p>
    </div>
    <div class="box">
    ...
    <div class="box box-success box-solid">
        ...
        <div class="box-body">
        	<dl>
        		<dt>Data Modul</dt>
                <dd>
                	Kelompok Data Modul digunakan untuk menambah modul, mata pelajaran, dan soal. Serta digunakan untuk mengatur file dengan memanfaatkan File Manager.
                	<ol>
                		<li>Modul</li>
                ...
                <dt>Data Peserta</dt>
                <dd>
                	Kelompok Data Peserta digunakan untuk mengatur Peserta, dan Kelas.
                	<ol>
                		<li>Daftar Kelas</li>

...
<section class="content-header">
	<h1>
		Backup Data
		<small>Backup data Aplikasi KALIMA TEST meliputi database dan file yang diupload.</small>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database KALIMA TEST. Simpan backup database pada tempat yang aman.</p>
        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio) pada KALIMA TEST. Simpan backup data pada tempat yang aman.</p>
                        <p>Data file yang di upload akan disimpan dalam bentuk archive.</p>
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama KALIMA TEST</p>
                    </div>
		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Setelah KALIMA TEST digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>

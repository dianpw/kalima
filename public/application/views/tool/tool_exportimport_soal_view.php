...
<section class="content-header">
	<h1>
		...
		<small>Fasilitas untuk melakukan Export dan Import data Soal yang sudah dimasukkan ke KALIMA TEST</small>
	</h1>
	<ol class="breadcrumb">
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Export / Import dapat digunakan untuk mendistribusikan Soal yang sudah di entry. Soal didistribusikan ke server lain yang sudah terinstall KALIMA TEST.</p>
                <p>Pastikan sebelum melakukan Import Data Soal tidak ada Mata Pelajaran pada KALIMA TEST.</p>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <?php echo form_open_multipart($url.'/importsoal','id="form-import"'); ?>
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Pastikan Mata Pelajaran pada menu Data Modul Kosong sebelum melakukan Import Data Soal.</p>

        ...
        <div class="col-xs-3">
                <div class="box">
                    <div class="box-header with-border">
                        <div class="box-title">Pilih Modul / Mata Pelajaran</div>
                    </div><!-- /.box-header -->
						...
						<div class="form-group">
                            ...
                            <div id="data-kelas">
                                <select name="topik" id="topik" class="form-control input-sm">
                                    <option value="kosong">Pilih Mata Pelajaran</option>
                                </select>
                            </div>
                            <small>Pilih modul dan mata pelajaran terlebih dahulu sebelum menambah atau mengubah soal</small>
                        </div>
                    </div>
	...
	function refresh_topik(){
		...
		$.getJSON('<?php echo site_url().'/'.$url; ?>/get_topik_by_modul/'+modul_id, function(data){
            ...
            if(data.data==1){
				...
				$topik.append('<option value="kosong">Tidak Ada Mata Pelajaran</option>');
			}
        });
	}

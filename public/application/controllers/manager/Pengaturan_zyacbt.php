...
class Pengaturan_zyacbt extends Member_Controller {
    ...
    public function index($page=null, $id=null){
        ...
        $this->template->display_admin($this->kelompok.'/pengaturan_zyacbt_view', 'Pengaturan KALIMA TEST', $data);
    }

    function simpan(){
        $this->load->library('form_validation');
        
        $this->form_validation->set_rules('zyacbt-nama', 'Nama KALIMA TEST','required|strip_tags');
        $this->form_validation->set_rules('zyacbt-keterangan', 'Keterangan KALIMA TEST','required|strip_tags');

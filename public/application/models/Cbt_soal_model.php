...
class Cbt_soal_model extends CI_Model{
    ...
    function get_by_topik_tipe_kesulitan_select_limit($topik, $tipe, $kesulitan, $select, $limit){
        ...
        $sql = 'SELECT '.$select.' FROM cbt_soal WHERE soal_topik_id="'.$topik.'" AND soal_difficulty="'.$kesulitan.'" '.$tipe_sql.' ORDER BY soal_tipe, RAND(soal_id) LIMIT '.$limit;
    ...
    function get_by_topik_tipe_kesulitan_select_limit_tanpa_acak($topik, $tipe, $kesulitan, $select, $limit){
        ...
        $sql = 'SELECT '.$select.' FROM cbt_soal WHERE soal_topik_id="'.$topik.'" AND soal_difficulty="'.$kesulitan.'" '.$tipe_sql.' ORDER BY soal_tipe ASC LIMIT '.$limit;
